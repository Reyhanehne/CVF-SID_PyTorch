...
To train and evaluate the model directly please visit [SIDD](https://www.eecs.yorku.ca/~kamel/sidd/benchmark.php) websites and download the original `Noisy sRGB data` and `Ground-truth sRGB data` and place them in `data/SIDD_Small_sRGB_Only` folder.
